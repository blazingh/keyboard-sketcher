...
export const initialNodes: Node[] = [
  ...
  { id: "7", type: 'switch', position: { x: -190, y: 190 }, data: { label: 'Switch', rotation: '0', width: 140, height: 140 }, zIndex: 10 },
  { id: "8", type: 'switch', position: { x: 0, y: -190 }, data: { label: 'Switch', rotation: '0', width: 140, height: 140 }, zIndex: 10 },
